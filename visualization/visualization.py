...
class visualization:
    ...
    def bbox_geometry(self, bounding_box, color=[0, 1, 0]):
        """creates an open3d line set from a bounding box
        ...
        corner_points = corner_points_array.tolist()
        ...
        bounding_box.points = o3d.utility.Vector3dVector(corner_points)  # Flatten the points
